...
# Main network
main_net = data_dict["toyexample"]

# Define Agents
Cook = nd.Agent("Cook")
Assistant = nd.Agent("Assistant")

###### Your Job: Assign nodes to agents ######

###### This defines the architecture 1!!! #######
agent_assignments = {
    "Cook": ["TF", "IU", "IP", "HA", "IC", "IM"],
    "Assistant": []
}

###### This defines the architecture 2!!! #######
###### Only have one architecture uncommented at a time before running visualization ######
agent_assignments = {
    "Cook": ["TF", "IU", "IP", "HA", "IC", "IM"],
    "Assistant": []
}
